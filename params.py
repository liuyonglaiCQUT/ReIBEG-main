...
def get_params():
    ...
    args.add_argument("-data", "--dataset", default="NELL-One", type=str)  # ["NELL-One", "FB15k-237"]
    args.add_argument("-path", "--data_path", default="./NELL", type=str)  # ["./NELL",  "./FB15k-237"]
    ...
    args.add_argument("-state_dict_filename", "--state_dict_filename", default="state_dict_fb15k_best_658", type=str)

    args.add_argument("-b", "--beta", default=5, type=float)  # 5
    args.add_argument("-m", "--margin", default=3.0, type=float)
    args.add_argument("-p", "--dropout_p", default=0.3, type=float)
    ...
    args.add_argument("-kl_lambda", "--kl_lambda", default=0.01, type=float)
    args.add_argument("-weight_decay", "--weight_decay", default=1e-7, type=float)
    args.add_argument("-power", "--power", default=0.80, type=float)
